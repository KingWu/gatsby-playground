...
import PageSEO from 'components/container/seo/pageSEO'
...
const IndexPage = () => {
  ...
  return (
    <>
      ...
      />
      <main className='app' style={pageStyles}>
        <title>Home Page</title>
        <PlatButton
          className={`${styles['index-test']}`}
          text={t('change-locale')}
          onClick={() => changeLanguage(language === 'en' ? 'zh-HK' : 'en')}
        />
        <TextField />
        <button
          className={styles['index-test']}
        ...
        <h1 style={headingStyles}>
          Congratulations
          <br />
          <Link to="/test/" onClick={onTestLinkClick}>Go Test</Link>
